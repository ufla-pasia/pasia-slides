...
Adicione um obotão `Jogar` que deve aparecer antes do jogo começar e reaparecer
...
continue lá, inclusive, respondendo a cliques.
...
do jogo vai aumentar 10% a cada nível.
...
É interessante aumentar não só as velocidades dos alines, mas também da nave do jogador
e dos projéteis.
::::
...
Ela deve ter um método para desenhar o placar na tela, no canto superior direito.
...
:::: {.callout-note title="Tarefa 3.5 - Garantindo que todos os ataques são pontuadas" icon=false, .nonincremental}
...
:::: {.callout-note title="Tarefa 3.2 - Preparando a classe Nave" icon=false, .nonincremental}
...
:::: {.callout-note title="Tarefa 3.3 - Desenhando as vidas do jogador" icon=false, .nonincremental}
...
# Dicas finais {background-color="#40666e"}
