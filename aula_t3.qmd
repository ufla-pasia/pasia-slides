...
# As 10 Principais Estruturas de Programação do Python {background-color="#40666e"}

##

O livro que estamos usando como referência, lista as **10 principais estruturas de programação do Python** que precisamos entender
...
## As10 Principais estruturas de programação do Python
...
- Mas poderia ser tedioso para outros uma aula assim, em formato expositivo.

##

Creio que é muito mais interessante, especialmente para quem já fez outras disciplinas de programação, estudar as estruturas de maneira mais prática e interativa.
...
::: {.callout-note}
#### Dar contexto
Considere que sou estudante de Ciência da Computação. Já fiz disciplinas introdutórias de programação, mas tenho certa dificuldade dificuldade com conceitos de programação. Conheço razoavelmente a linguagem Java e agora gostaria de aprender Python.
:::
:::
...
::: {.callout-note}
#### Definir o formato da resposta esperada
Gostaria que a sessão fosse interativa, apresentando um conceito de cada vez, com exemplos práticos e comparações com Java.
:::
:::

. . .

Você pode montar um texto único com tudo que escrevemos ou você pode ser mais específico indicando algo como:
...
Nesse caso como pedi uma sessão interativa, podemos experimentá-la e,
...
```
Contexto: Considere que sou estudante de Ciência da Computação. Já fiz disciplinas introdutórias de programação, mas tenho certa dificuldade dificuldade com conceitos de programação. Conheço razoavelmente a linguagem Java e agora gostaria de aprender Python.
...
Formato: Gostaria que a sessão fosse interativa, apresentando um conceito de cada vez, com exemplos práticos e comparações com Java.
```
