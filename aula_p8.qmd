...
- Faremos isso dois tipos de APIs bem diferentes.
...
Pela documentação, vemos que existe uma consulta por município:
  ...
  - [https://servicodados.ibge.gov.br/api/v4/malhas/municipios/{id}
  ](https://servicodados.ibge.gov.br/api/v4/malhas/municipios/{id})
...
Para conseguirmos exibir esse polígono podemos usar a biblioteca plotly.
...
:::: {.callout-note title="Tarefa 2 - Exibindo polígono do município" icon=false, .nonincremental}
...
- E exibir o polígono do município escolhido, usando a API Plotly.
::::

##

:::: {.callout-note title="Tarefa 3 - Exibindo polígono no mapa-mundi" icon=false, .nonincremental}
É possível que no passo anterior você tenha conseguido exibir o polígono do município, mas isolado, 
sem o mapa-mundi de fundo.

- Incremente o programa do passo anterior de forma que o polígono do município seja exibido sobre o mapa-mundi.

Dica: use zoom-out na hora de testar.
::::

##

:::: {.callout-note title="Tarefa 4 - Incluindo mais informações no mapa" icon=false, .nonincremental}
Altere o programa para que ele use a API de Municípios do IBGE para obter mais informações sobre o município escolhido.

- Inclua o população e o PIB per capita do município como tooltip no polígono.
::::

##

:::: {.callout-note title="Tarefa 5 - Incluindo mais municípios" icon=false, .nonincremental}
Altere o programa para que o usuário possa escolher vários municípios e sejam exibidos os polígonos e
tooltips de todos eles no mapa.
::::
