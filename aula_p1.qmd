...
- Extensão de Python para VS Code (da Microsoft)
  - Você pode instalar digitando <kbd>Ctrl</kbd> + <kbd>P</kbd> no VS Code e digitando `ext install ms-python.python`.
...
Experimente selecionar o código que você acabou de gerar e aperte <kbd>Ctrl</kbd> + <kbd>I</kbd>.
