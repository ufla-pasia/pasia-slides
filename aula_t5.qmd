...
# Observações sobre as últimas aulas {background-color="#40666e"}
...
Notei uma resistência muito grande de boa parte dos alunos em decompor o problema da
aula passada.
...
Lembrem-se que a expectativa é que no futuro nosso trabalho será fortemente
baseado em assistência com IA.
...
Como diz o ditado _"Apressado come cru"_.
...
## Aula ANP 10 de Setembro

10/09 teremos o UFLA de Portas Abertas.

- Assim não teremos aula presencial.
- A presença será dada pela entrega da atividade de decomposição de problemas da aula passada.
- É essencial apresentar o diagrama da decomposição do problema.

# Trabalho Prático {background-color="#40666e"}
