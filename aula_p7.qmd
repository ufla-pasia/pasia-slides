...
a serem exibidos (maios populosos, de maior PIB per capta, etc), usando um menu suspenso (_dropdown_).
::::
...
Ou seja, quais colunas representarão os eixos X e Y e o tamanho e a cor dos pontos.
::::
